...
let countOfPorts = config.count, // total number of ports to be opened
    low = config.range.low, // lower range of the numeber ports to be opened (inclusive)
    high = config.range.high; // higher range of ports to be opened (exclusive)

// generating the new ports
...
console.log(`Starting the server at ${countOfPorts} different ports....`);
